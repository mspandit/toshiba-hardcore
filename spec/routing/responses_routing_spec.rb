...
describe ResponsesController do
  describe "routing" do
    ...
    it "rotues root to #public_new" do
      get("/").should route_to("responses#public_new")
    end
    ...
    it "routes to #ajax_create" do
      post("/responses/ajax_create").should route_to("responses#ajax_create");
    end
